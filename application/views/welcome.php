...
<head>
  <title>Oong Julian Fernanda</title>
  <meta charset="utf-8">
  <meta name="viewport" content="width=device-width, initial-scale=1">
  <link rel="stylesheet" href="<?php echo base_url(); ?>css/bootstrap.min.css">
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/font-awesome.min.css">
  <link href='https://fonts.googleapis.com/css?family=Open+Sans:300,600|Raleway:600,300|Josefin+Slab:400,700,600italic,600,400italic' rel='stylesheet' type='text/css'>
  <link rel="stylesheet" type="text/css" href="<?php echo base_url(); ?>css/slick-team-slider.css" />
...
<body>
    ...
    <nav class="navbar navbar-default">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="index.html">OONG</a>
        </div>
  ...
  <div id="banner" class="section-padding">
    <div class="container">
      <div class="row">
        <div class="jumbotron">
          <h1 class="small">Welcome To <span class="bold">My Website</span></h1>
          <p class="big">My Personal Website.</p>
  ...
  <div class="cta-1">
    <div class="container">
      <div class="row text-center white">
        <h1 class="cta-title">Say Hey !!</h1>
        <p class="cta-sub-title">Full Service 24 hour in making a website.</p>
      </div>
    </div>
  </div>
  <!--CTA1 END-->
    ...
    <div class="container">
      <div class="row">
        <div class="page-title text-center">
          <h1>Our Service</h1>
          <p>Creating profile website and web programming <br>Let see. </p>
        ...
        <div class="col-md-4">
          <div class="service-box">
            ...
            <div class="service-text">
              <h3>Design</h3>
              <p> Development Bootstrap and Web desain Creation service for corporate or personal purposes.</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="service-box">
            ...
            <div class="service-text">
              <h3>Development</h3>
              <p> Development Website, Web programing, and Web Desain. Web Creation service for corporate or personal purposes</p>
            </div>
          </div>
        </div>
        <div class="col-md-4">
          <div class="service-box">
            ...
            <div class="service-text">
              <h3>Marketing</h3>
              <p> Our Marketing team can be contactedd at the following number 0822818034.</p>
            </div>
          </div>
        </div>
      </div>

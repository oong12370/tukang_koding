 <div class="col-12 grid-margin stretch-card">
              <div class="card">
                <div class="card-body">
                  ...
                  <?php foreach ($getkonten as $getkonten): ?>
                  </p>
                  <form class="forms-sample" method="post" action="<?=site_url('admin/edit_konten/'.$getkonten->id_konten)?>">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="nama_konten" value="<?php echo $getkonten->nama_konten; ?>" name="nama_konten" placeholder=" Judul" required>
                    </div>
                    <div class="form-group">
                    ...
                    <label for="nama_konten">Deskripsi</label>
                        <div>
                          <textarea name="deskripsi" id="deskripsi" class="form-control"><?php echo $getkonten->deskripsi; ?></textarea>
                        </div>
                      </div>
